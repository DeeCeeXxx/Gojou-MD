...
2.  **Get `SESSION ID` BY [`PAIRING CODE`](https://davidcyril-session-id-generator.onrender.com/pair)
 OR BY [`SCANNING QR CODE1`](https://davidcyril-session-id-generator.onrender.com/wasiqr)** 
